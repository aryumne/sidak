    ...
    <form action="" method="post" enctype="multipart/form-data">
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="number" class="form-control" id="nik" name="nik" maxlenght="16" placeholder="NIK"
                        required>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="file" class="form-control" id="file_datang" name="file_datang" required>
                </div>
            </div>
...
if (isset($_POST['Simpan'])) {
	...
	if (isset($_FILES['file_datang']['name'])) {
		$ext_allowed = 'pdf';
		...
		if ($ext === $ext_allowed) {
			if ($size < 102400) {
				...
				$sql_simpan =
					"INSERT INTO tb_datang (nik, nama_datang, jekel, tgl_datang, pelapor, filename_datang, path_file) VALUES (
			'" . $_POST['nik'] . "',
			'" . $_POST['nama_datang'] . "',
			'" . $_POST['jekel'] . "',
			'" . $_POST['tgl_datang'] . "',
