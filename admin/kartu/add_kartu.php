	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="number" class="form-control" id="no_kk" name="no_kk" maxlenght="16" placeholder="No KK" required>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input type="number" class="form-control" id="rt" name="rt" maxlenght="2" placeholder="RT" required>
				</div>
				<div class="col-sm-3">
					<input type="number" class="form-control" id="rw" name="rw" maxlenght="2" placeholder="RW" required>
				</div>
			</div>
