<div class="card card-secondary">
	...
	<div class="card-body">
		<div class="table-responsive">
			<div>
				<a href="?page=add-mendu" class="btn btn-info">
            ...
            ?>
					...
					<tr>
						...
						<td>
							...
							<a href="?page=del-mendu&pdd=<?php echo $data['id_pend']; ?>&mendu=<?php echo $data['id_mendu']; ?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')"
