<div class="card card-secondary">
	...
	<div class="card-body">
		<div class="table-responsive">
			<div>
				<a href="?page=add-pindah" class="btn btn-info">
            ...
            ?>
					...
					<tr>
						...
						<td>
							...
							<a href="?page=del-pindah&pend=<?php echo $data['id_pend']; ?>&pindah=<?php echo $data['id_pindah']; ?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')"
